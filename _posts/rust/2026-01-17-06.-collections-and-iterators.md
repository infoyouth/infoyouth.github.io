...
description: "🦀 Master Rust collections and iterators! Learn Vec, HashMap, iterators, lazy evaluation, and zero-cost abstractions. 🚀"
author: infoyouth
...
<details style="border: 3px solid #ff6b6b; border-radius: 8px; padding: 15px; margin-top: 15px;">
<summary style="cursor: pointer; font-weight: bold; color: #fff; background-color: #ff6b6b; padding: 12px; border-radius: 6px; font-size: 18px;">📋 Click to Expand Assignment Details</summary>
