...
# <span style="color:#e67e22">✅ Hands-on Assignment: Build Your User Greeter</span>

Now it's time to solidify your TypeScript knowledge by building a practical project!

## <span style="color:#2980b9">📋 Project: User Greeter Application</span>

Create a TypeScript project that demonstrates type safety and interfaces:

### <span style="color:#8e44ad">Part 1: Project Setup</span>
...
### <span style="color:#8e44ad">Part 2: Create Type-Safe User Module</span>
...
3. Add input validation (e.g., age must be positive, email must contain '@')

### <span style="color:#8e44ad">Part 3: Build Main Application</span>
...
### <span style="color:#8e44ad">Part 4: Enable Strict Mode (Bonus)</span>
...
You've taken your first steps into TypeScript's world of type-safe development! By understanding its core features, setting up your environment, and writing your first program, you're now equipped to build more reliable applications. Practice with the hands-on assignment, explore the interactive playgrounds, and remember that every type error caught at compile-time is a bug prevented at runtime—making TypeScript an invaluable tool for modern web development.
