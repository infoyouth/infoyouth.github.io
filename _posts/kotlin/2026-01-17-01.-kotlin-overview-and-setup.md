...
<details style="border: 3px solid #9b59b6; border-radius: 8px; padding: 15px; margin-top: 15px;">
<summary style="cursor: pointer; font-weight: bold; color: #fff; background-color: #9b59b6; padding: 12px; border-radius: 6px; font-size: 18px;">🎯 Mission: Create a Personal Finance Tracker Application</summary>
