...
graph LR
    ...
    F[Stack] --> G(Local Variables);
    F --> H(Function Call Info);
    I[Heap] --> J(Dynamically Allocated Memory);
...
graph LR
  ...
  style B fill:#f0fff0,stroke:#333,stroke-width:1px
  style C fill:#ffe4e1,stroke:#333,stroke-width:1px
  style D fill:#f0f8ff,stroke:#333,stroke-width:1px
  style E fill:#ffffef,stroke:#333,stroke-width:1px
  style F fill:#f5f5dc,stroke:#333,stroke-width:1px
...
graph TD
    ...
    D --> E[Free allocated memory using free()];
...
graph LR
    ...
    C -- malloc() --> D[Allocate uninitialized memory];
    C -- calloc() --> E[Allocate initialized to zero memory];
...
Here’s a simple Mermaid diagram to visualise it:
...
graph LR
    ...
    J -- Yes --> K[Free the memory using free()];
    K --> L[End]
    E --> L;
    I --> K
```
