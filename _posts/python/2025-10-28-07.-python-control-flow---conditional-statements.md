...
{% include code-playground.html 
   language="python" 
   code="# Comprehensive if-elif-else Examples
...
if purchase_amount >= 100 and is_member:
    ...
    print(f\"Total: ${purchase_amount - discount:.2f}\")
elif purchase_amount >= 100:
    discount = purchase_amount * 0.10  # 10% discount
    print(f\"Regular discount: ${discount:.2f}\")
    print(f\"Total: ${purchase_amount - discount:.2f}\")
else:
    print(f\"No discount. Total: ${purchase_amount:.2f}\")" 
   height="750px" 
   gradient="purple" 
%}
...
{% include code-playground.html 
   language="python" 
   code="# Nested If Statements and Logical Operators

# Example 1: Nested if for Driving Eligibility
age = 20
has_license = True
has_insurance = True
...
# Example 2: Simplified with Logical Operators (Better!)
age = 20
has_license = True
has_insurance = True

if age >= 18 and has_license and has_insurance:
    print(\"You can drive! 🚗 (Simpler version)\")
...
# Example 3: Nested Conditions for Admission
has_degree = True
gpa = 3.7
entrance_score = 85
...
if has_degree:
    if gpa >= 3.5:
        if entrance_score >= 80:
            print(\"Congratulations! You're admitted! 🎓\")
        else:
            print(\"Your entrance score is too low.\")
    else:
        print(\"Your GPA doesn't meet the requirement.\")
else:
    print(\"You need a bachelor's degree to apply.\")

print(\"\\n\" + \"=\"*50 + \"\\n\")

# Example 4: Using Guard Clauses (Best Practice!)
def check_admission(has_degree, gpa, entrance_score):
    # Check error conditions first and return early
    if not has_degree:
        return \"You need a bachelor's degree to apply.\"
    
    if gpa < 3.5:
        return \"Your GPA doesn't meet the requirement.\"
    
    if entrance_score < 80:
        return \"Your entrance score is too low.\"
    
    # Primary logic - only reached if all conditions pass
    return \"Congratulations! You're admitted! 🎓\"

result = check_admission(True, 3.7, 85)
print(result)" 
   height="800px" 
   gradient="green" 
%}
