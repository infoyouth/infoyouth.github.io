...
{% include code-playground.html language="python" code="# Python String Slicing Demo
my_string = \"PythonIsAwesome\"
...
print(\"First 6 characters [0:6]:\", my_string[0:6])
print(\"Same as above [:6]:\", my_string[:6])
print(\"From index 6 to end [6:]:\", my_string[6:])
print(\"From index 2 to 10 [2:10]:\", my_string[2:10])

print(\"\\n\" + \"=\"\*50 + \"\\n\")

# Step slicing

print(\"Every 2nd character [::2]:\", my_string[::2])
print(\"Every 3rd character [::3]:\", my_string[::3])
print(\"Characters 2-10, step 2 [2:10:2]:\", my_string[2:10:2])

print(\"\\n\" + \"=\"\*50 + \"\\n\")

# Reverse string

print(\"Reversed string [::-1]:\", my_string[::-1])
print(\"Reverse every 2nd [::-2]:\", my_string[::-2])

# Try changing my_string to your own text!" height="600" gradient="purple" %}
...
{% include code-playground.html language="python" code="# Python String Split and Join Demo
...
limited = csv_data.split(\",\", 2) # Split at most 2 times
print(\"Split max 2 times:\", limited)
...
joined_space = \" \".join(words_list)
print(\"Join with space:\", joined_space)

joined_dash = \"-\".join(words_list)
print(\"Join with dash:\", joined_dash)

joined_empty = \"\".join(words_list)
print(\"Join with no separator:\", joined_empty)

# Real-world example: CSV formatting

data = ['Alice', '25', 'Engineer', 'New York']
csv_line = \",\".join(data)
print(\"\\nCSV formatted:\", csv_line)" height="650" gradient="green" %}
...
{% include code-playground.html language="python" code="# Python f-string Formatting Demo (Python 3.6+)
...
age = 30
city = \"London\"
print(f\"Hello, I'm {name}. I'm {age} years old and live in {city}.\")
...
print(f\"Total: ${price _quantity}\")
print(f\"Price per item with tax: ${price_ 1.1:.2f}\")
...
print(f\"Grade: {'A' if percentage >= 90 else 'B' if percentage >= 80 else 'C'}\")" height="650" gradient="pink" %}
...
<details>
<summary><strong>💡 Project: Text Analyzer Tool</strong> (Click to expand)</summary>
<br>
<p><strong>Your Challenge:</strong></p>
<p>Build a text analysis tool that takes a sentence and provides statistics and transformations using string methods!</p>

<p><strong>Implementation Hints:</strong></p>
<ul>
<li>Start with a sample sentence like <code>text = "Python programming is fun!"</code></li>
<li>Use <code>len()</code> for character count, <code>split()</code> for word count</li>
<li>Apply transformations: <code>.upper()</code>, <code>.lower()</code>, <code>.title()</code></li>
<li>Reverse the text using slicing: <code>text[::-1]</code></li>
<li><strong>Bonus:</strong> Create acronyms, check palindromes, count vowels</li>
</ul>
...
<p>Completed the project? <strong>Post your code in the comments below!</strong> Show us your creative approach - maybe you added extra features? 🎨</p>
